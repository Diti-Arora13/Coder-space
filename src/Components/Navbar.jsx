  ...
  return (
    <div className="flex fixed top-0 left-0 right-0 bg-dark-purple px-12 py-4 justify-between items-center">
        ...
        <div className="flex items-center">
          <Link className={`${logged && 'sm:visible invisible'} button`} to={logged ? '/profile' : '/signup'}>{firstBtn}</Link>
          {logged && <Link className='sm:visible invisible button mx-10' to='/createPost' >Create Post</Link>}
